...
namespace Tayx.Graphy.Fps
{
    ...
    {
        public G_FpsText(IntPtr obj) : base(obj) { }
        #region Variables -> Serialized Private

        [SerializeField] public    Text            m_fpsText               = null;
        [SerializeField] public    Text            m_msText                = null;
                         
        [SerializeField] public    Text            m_avgFpsText            = null;
        [SerializeField] public    Text            m_onePercentFpsText     = null;
        [SerializeField] public    Text            m_zero1PercentFpsText   = null;
        ...
        private void Awake()
        {
            m_fpsText = transform.FindChild("fps_text_value").GetComponent<Text>();
            m_msText = transform.FindChild("ms_text_value").GetComponent<Text>();
            m_avgFpsText = transform.FindChild("avg_fps_value").GetComponent<Text>();
            m_onePercentFpsText = transform.FindChild("1%_fps_value").GetComponent<Text>();
            m_zero1PercentFpsText = transform.FindChild("0.1%_fps_value").GetComponent<Text>();

...
namespace Tayx.Graphy.Ram
{
    ...
    {
        public G_RamGraph(IntPtr obj) : base(obj) { }
        #region Variables -> Serialized Private

        [SerializeField] public    Image           m_imageAllocated = null;
        [SerializeField] public    Image           m_imageReserved = null;
        [SerializeField] public    Image           m_imageMono = null;
        [SerializeField] public    Shader          ShaderFull = null;
        [SerializeField] public    Shader          ShaderLight = null;
        ...
        private void Awake() 
        {
            m_imageAllocated = transform.FindChild("ram_allocated_graph").GetComponent<Image>();
            m_imageMono = transform.FindChild("ram_allocated_graph/ram_reserved_graph").GetComponent<Image>();
            m_imageMono = transform.FindChild("ram_allocated_graph/ram_mono_graph").GetComponent<Image>();
            ShaderFull = GraphyForVRC.Main.standard.shader;
            ShaderLight = GraphyForVRC.Main.mobile.shader;

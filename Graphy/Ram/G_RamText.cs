...
namespace Tayx.Graphy.Ram
{
    ...
    {
        public G_RamText(IntPtr obj) : base(obj) { }
        #region Variables -> Serialized Private

        [SerializeField] public    Text            m_allocatedSystemMemorySizeText         = null;
        [SerializeField] public    Text            m_reservedSystemMemorySizeText          = null;
        [SerializeField] public    Text            m_monoSystemMemorySizeText              = null;
        ...
        private void Awake()
        {
            m_allocatedSystemMemorySizeText = transform.FindChild("allocated_system_memory_size_text").GetComponent<Text>();
            m_reservedSystemMemorySizeText = transform.FindChild("reserved_system_memory_size_text").GetComponent<Text>();
            m_reservedSystemMemorySizeText = transform.FindChild("mono_system_memory_size_text").GetComponent<Text>();

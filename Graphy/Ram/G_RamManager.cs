...
namespace Tayx.Graphy.Ram
{
    ...
    {
        public G_RamManager(IntPtr obj) : base(obj) { }
        /* ----- TODO: ----------------------------
        ...
        [SerializeField] public    GameObject              m_ramGraphGameObject = null;
        ...
        private void Awake()
        {
            ...
            m_ramGraphGameObject = transform.FindChild("ram_allocated_graph").gameObject;

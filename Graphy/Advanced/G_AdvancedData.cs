...
namespace Tayx.Graphy.Advanced
{
    ...
    {
        public G_AdvancedData(IntPtr obj) : base(obj) { }
        ...
        [Range(1, 60)]
        [SerializeField] private    float                       m_updateRate                    = 5f;  // 1 update per sec.
        ...
        private void Awake()
        {
            m_backgroundImages.Add(transform.FindChild("BG_Image").GetComponent<Image>());
            m_graphicsDeviceNameText = transform.FindChild("graphics_device_version_text").GetComponent<Text>();
            m_processorTypeText = transform.FindChild("processor_type_text").GetComponent<Text>();
            m_operatingSystemText = transform.FindChild("operating_system_and_ram_text").GetComponent<Text>();
            m_systemMemoryText = transform.FindChild("ram_text").GetComponent<Text>();
            m_graphicsDeviceNameText = transform.FindChild("graphics_device_name_text").GetComponent<Text>();
            m_screenResolutionText = transform.FindChild("screen_res_value_text").GetComponent<Text>();
            m_gameWindowResolutionText = transform.FindChild("window_res_text_value").GetComponent<Text>();

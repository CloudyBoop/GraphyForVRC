...
namespace Tayx.Graphy.Audio
{
    ...
    {
        public G_AudioMonitor(IntPtr obj) : base(obj) { }
        public static G_AudioMonitor Instance;
        ...
        public         AudioListener                       m_audioListener                     = null;

        public         GraphyManager.LookForAudioListener  m_findAudioListenerInCameraIfNull   = GraphyManager.LookForAudioListener.ON_SCENE_LOAD;
        ...
        /// </summary>
        public AudioListener FindAudioListener()
        {
        ...
        private void Init()
        {
            ...
            if (Instance.m_findAudioListenerInCameraIfNull == GraphyManager.LookForAudioListener.ON_SCENE_LOAD)
            {
                Instance.m_audioListener = Instance.FindAudioListener();
            }
        }

...
namespace Tayx.Graphy.Audio
{
    ...
    {
        public G_AudioGraph(IntPtr obj) : base(obj) { }
        #region Variables -> Serialized Private

        [SerializeField] public    Image           m_imageGraph = null;
        [SerializeField] public    Image           m_imageGraphHighestValues = null;
        ...
        private void Awake()
        {
            m_imageGraph = transform.FindChild("audio_spectrum_graph").GetComponent<Image>();
            m_imageGraphHighestValues = transform.FindChild("audio_spectrum_graph/audio_spectrum_highest_values_graph").GetComponent<Image>();

...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : MonoBehaviour
    {
        ...
        public GraphyManager(IntPtr obj) : base(obj) { }
        ...
        [SerializeField] private    Color                   m_allocatedRamColor                 = new Color(255, 190, 60, 255);
        [SerializeField] private    Color                   m_reservedRamColor                  = new Color(205, 84, 229, 255);
